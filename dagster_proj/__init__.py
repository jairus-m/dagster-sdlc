...
ml_assets = load_assets_from_modules([ml_analytics.energy_prediction], group_name="ml_pipeline")
dashboard_assets = load_assets_from_modules([ml_analytics.weekly_totals], group_name="analytics")
